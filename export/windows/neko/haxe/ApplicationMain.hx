...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "LD36", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LD36", null, { width: 640, height: 320 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 640, height: 320 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 640, 320, "null");
		#end
		#else
		create ();
		#end
