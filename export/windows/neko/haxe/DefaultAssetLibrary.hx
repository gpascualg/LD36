...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/background.txt", "assets/data/background.txt");
		type.set ("assets/data/background.txt", AssetType.TEXT);
		path.set ("assets/data/foreground.txt", "assets/data/foreground.txt");
		type.set ("assets/data/foreground.txt", AssetType.TEXT);
		path.set ("assets/images/barrel.png", "assets/images/barrel.png");
		type.set ("assets/images/barrel.png", AssetType.IMAGE);
		...
		var id;
		id = "assets/data/background.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/foreground.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/barrel.png";
		path.set (id, id);
